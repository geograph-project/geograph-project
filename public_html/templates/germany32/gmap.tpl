...
{literal}
	...
	//<![CDATA[
		...
		function UTMProj(ri) {
			...
			this.latmax = 56;
			this.y0 = -5200;
			this.pixperkm=[ 0.3, 1, 4, 40 ];
			this.kmpertile=[ 666, 200, 50, 5];
			//this.yflip = [1331, 999, 999, 999];
			this.yflip = [1332, 1000, 1000, 1000];
			//this.xmin = 0;
			//this.xmax = 900;
			this.ymin = 0;
			this.ymax = 1000;
		...
		function GetTileUrl_Geo(txy, z, ri) {
			var pixperkm=[ 0.3, 1, 4, 40 ];
			var kmpertile=[ 666, 200, 50, 5];
			//var yflip = [1331, 999, 999, 999];
			var yflip = [1332, 1000, 1000, 1000];
			var ts = 200;
		...
		function loadmap() {
			if (GBrowserIsCompatible()) {
				...
				var tilelayers3 = [new GTileLayer(copyrightCollection,0,3)];
				...
				var tilelayers4 = [new GTileLayer(copyrightCollection,0,3)];
				...
				var tilelayers5 = [new GTileLayer(copyrightCollection,0,3)];
				...
				//var geomap3 = new GMapType(tilelayers3, new UTMProj(3), "Z32", {tileSize: 200});
				//var geomap4 = new GMapType(tilelayers4, new UTMProj(4), "Z33", {tileSize: 200});
				//var geomap5 = new GMapType(tilelayers5, new UTMProj(5), "Z31", {tileSize: 200});
				var geomap3 = new GMapType(tilelayers3, proj3, "Z32", {tileSize: 200});
				var geomap4 = new GMapType(tilelayers4, proj4, "Z33", {tileSize: 200});
				var geomap5 = new GMapType(tilelayers5, proj5, "Z31", {tileSize: 200});
				var curmap = geomap3;

...
alt="Creative Commons Licence [Some Rights Reserved]" src="/img/somerights20.gif" /></a> &nbsp; Image used on this page, &copy; Copyright {$game->image->realname|escape:'html'} and  

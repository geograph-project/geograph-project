...
{dynamic}
<h2><a name="top"></a><img src="{$curproto}www.gravatar.com/avatar/{$profile->md5_email}?r=G&amp;d={$curproto}www.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536%3Fs=30&amp;s=50" alt="{$profile->realname|escape:'html'}'s Gravatar" style="vertical-align:middle;padding-right:10px"/>Profile for {$profile->realname|escape:'html'}</h2>
{/dynamic}

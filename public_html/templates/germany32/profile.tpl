...
{if $userimages}
	...
	<ul>
		...
		<li><b>Maps</b>: {if $profile->stats.images gt 10}<a href="/profile/{$profile->user_id}/map" rel="nofollow">Personalised Geograph Map</a> (<a href="/profile/{$profile->user_id}/mmap" rel="nofollow">no zones</a>) or {/if} Recent Photos on <a href="http://maps.google.de/maps?q=http://{$http_host}/profile/{$profile->user_id}/feed/recent.kml&amp;ie=UTF8&amp;om=1">Google Maps</a></li>

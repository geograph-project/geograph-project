...
<div style="position:relative;">
	...
	<div style="position:relative;{if $tab != 1}display:none{/if}" class="interestBox" id="div1">
		...
		<input id="grid_reference" type="text" name="grid_reference" value="{$grid_reference|escape:'html'}" size="16"/><small class="navButtons"><small><a href="javascript:doMove('grid_reference',-1,0);">W</a></small><sup><a href="javascript:doMove('grid_reference',0,1);">N</a></sup><sub><a href="javascript:doMove('grid_reference',0,-1);">S</a></sub><small><a href="javascript:doMove('grid_reference',1,0);">O</a></small></small>
		&nbsp;&nbsp;&nbsp;
...
{if $step eq 2}
	...
	{foreach from=$images item=image}
	  ...
	  <div class="photo33" style="float:left;width:150px; height:170px; background-color:white">{newwin title="`$image->title` von `$image->realname` - Anklicken für Ansicht in voller Größe"|escape:'html' href="/photo/`$image->gridimage_id`" text=$image->getThumbnail(120,120,false,true,'src',3)}
...
<input type="submit" name="next" value="Weiter &gt;" style="float:right;" />
<input type="submit" name="goback" value="&lt; Zurück" style="float:right;" />
</div>
</p>

...
<h2>My Submissions{if $criteria}<small style="font-weight:normal">, submitted at or before: {$criteria|escape:'html'}</small>{/if}</h2>
	...
	{foreach from=$images item=image}
	 <div style="border-top: 2px solid lightgrey; padding-top:3px; position:relative; overflow:hidden;height:190px">
		<div style="position:absolute;top:-400px;width:100%;opacity:0.3">

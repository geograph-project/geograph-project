{assign var="page_title" value="Datenschutzerklärung"}
...
Diese werden temporär beim Besucher gespeichert und in der Regel vom Browser gelöscht. Diese verhindern einerseits,
dass der Browser im Laufe der Sitzung getätigte Nutzereingaben vergisst (z.B. die Navigation innerhalb der <a href="/mapbrowse.php">Landkarte</a>),
andererseits ermöglichen sie uns, <a href="https://de.wikipedia.org/wiki/Cross-Site-Request-Forgery">CSRF-Attacken</a> auf unsere Besucher zu verhindern.</p>
<p>Zusätzlich setzen wir auf Wunsch unserer User Cookies ein, damit dauerhafte Einstellungen gespeichert werden können, ohne registriert oder eingeloggt zu sein.
Momentan erfolgt dies für den Kartentyp der verschiedenen Landkarten.</p>
...
</li><li>der statistischen Auswertung zur Ermittlung ungewöhnlich hoher Zugriffszahlen bestimmter Unterseiten
zur Aufdeckung von missbräuchlichen Zugriffen und</li>
<li>der Untersuchung und Abwehr von Angriffen und Missbrauch unseres Angebots.</li>
</ul>
...
generiert wird, die an die Mitglieder des Support-Teams geschickt wird. Zur Erleichterung des Supports enthält diese auch
Information zu Browsertyp und zuletzt besuchter Unterseite der Web-Präsenz. Auf dem Server werden keine Daten gespeichert,
aber naturgemäß werden die Daten beim Versenden der Mail übertragen.</p>
<p>Zusätzlich besteht die Möglichkeit, unsere registrierten Teilnehmer über separate Kontaktformulare zu erreichen.
Auch hier werden keine Daten auf dem Server gespeichert, vielmehr wird aus der eingegebenen E-Mail-Adresse und
der IP-Adresse eine E-Mail konstruiert, die unmittelbar an die vom jeweiligen Teilnehmer angegebenen E-Mail-Adresse
versandt wird.</p>
<h4>Externe Inhalte (Landkarten, Profilbilder)</h4>
<p>
Als Geographie-Projekt sind wir naturgemäß daran interessiert,
zu den dokumentierten Motiven eine Vielzahl von verschiedenen Landkarten anzubieten.
Demzufolge binden wir auf Unterseiten, die Landkarten enthalten, auch Inhalte dritter ein.
</p><p>Zusätzlich ermöglichen wir unseren registrierten Teilnehmern,
auf deren Profilseite ein Profilbild einzubinden, das beim externen Dienst &bdquo;Gravatar&ldquo; gehostet wird.</p><p>
Manche Landkarten sind mit einem Suchfeld für Ortsnamen versehen. Da eine detaillierte Ortssuche für uns nicht umsetzbar ist,
...
<p>Unsere registrierten Teilnehmer können unter Ihrem Account Bilder und Texte veröffentlichen.
Die Teilnehmer sind selbstverständlich dazu angehalten, sich an geltendes Recht zu halten
und beispielsweise erforderlichenfalls das Einverständnis abgebildeter Personen einzuholen.
</p><p>Sollten Sie dennoch Bedenken bezüglich eines Nutzerbeitrags haben, melden Sie sich bitte
entweder beim betreffenden Teilnehmer über die Kontaktmöglichkeit auf dessen Profil- oder der
Fotoseite, oder wenden Sie sich über das <a href="https://{$http_host}/contact.php">Kontaktformular</a>
an uns.
</p>
<h3>Registrierte Teilnehmer</h3>
<p>Nutzer können sich bei uns registrieren um über unser Projekt Nutzerbeiträge zu veröffentlichen.
Dies sind insbesondere mit Geoinformationen versehene Bilder, die der Dokumentation der Geographie Deutschlands dienen,
aber auch Artikel, Tourbeschreibungen, Galerien oder Beiträge in unserem Forum.</p>
<h4>E-Mail-Adresse</h4>
<p>Bei der Registrierung ist die Angabe einer funktionierenden E-Mail-Adresse zwingend erforderlich um
einerseits die projektinterne Kommunikation sicherzustellen und andererseits nichtregistrierten
Besuchern die Kontaktaufnahme bei Fragen zu den Beiträgen des Teilnehmers zu ermöglichen. Hierbei ist anzumerken,
dass wir die E-Mail-Adresse des Nutzers <b>nicht</b> veröffentlichen, sofern er das nicht explizit für seine
Profilseite wünscht. Der Teilnehmer erhält aber Nachrichten
zu Korrekturen oder Nachfragen zu seinen Beiträgen oder zu von ihm abonnierten Forendiskussionen an
diese E-Mail-Adresse.</p>
<p>Zur Darstellung des Profilbilds auf der Profilseite wird, sofern vom Teilnehmer gewünscht,
die E-Mail-Adresse verschlüsselt und anschließend in der verschlüsselten Form an den Profilbild-Dienst &bdquo;Gravatar&ldquo; gesendet.
Auf diese Weise kann dieser Dienst ermitteln, ob für diese Adresse ein Profilbild vorliegt, ohne die E-Mail-Adresse selbst zu benötigen.
</p>
<p>Ist diese Speicherung und Verwendung der E-Mail-Adresse nicht erwünscht, ist von der Registrierung abzusehen.
Falls die Registrierung bereits erfolgt ist, wenden Sie sich bitte über das <a href="https://{$http_host}/contact.php">Kontaktformular</a>
an uns, damit wir den Account deaktivieren und die damit verbundenen Daten löschen können.</p>
<h4>Name</h4>
<p>Bei der Registrierung wird weiterhin um die Angabe eines Namen gebeten. Dies ist der Name,
unter dem der Teilnehmer mit seinen Beiträgen nach außen sichtbar sein möchte. Insbesondere ist dies für die Bildbeiträge
erforderlich, da diese unter einer <a href="https://creativecommons.org/licenses/by-sa/2.0/">Creative-Commons-Lizenz</a>
veröffentlicht werden, die die Verbreitung des Werks unter Nennung des Urhebers erlaubt.</p>
<p>Ob hier der tatsächliche Name angegeben wird, bleibt aber dem Teilnehmer überlassen, unter unseren Teilnehmern
sind sowohl abgekürzte Namen als auch Pseudonyme in Gebrauch.</p>
<p>Zusätzlich kann für die internen Foren ein Nickname gewählt werden.</p>
<h4>Profilseite</h4>
<p>Teilnehmer können auf eigenen Wunsch ihre Profilseiten mit Kontaktinformationen wie Web-Adresse,
öffentlich sichtbarer E-Mail-Adresse, Profilbild und freiem Text versehen. Diese Daten werden gemeinsam
mit anderen nutzerspezifische Einstellungen auf unserem Server gespeichert.</p>
<p>Diese Daten können ebenso wie nutzerspezifische Einstellungen jederzeit auf der Profilseite editiert werden.</p>
<h4>Nutzerbeiträge</h4>
<p>Die Beiträge, die unsere Teilnehmer über unsere Webpräsenz veröffentlichen, werden zu diesem Zweck dauerhaft gespeichert.
Dies gilt insbesondere für Fotografien einschließlich der Metadaten sowie für Artikel, Tourbeschreibungen, Galerien und Forenbeiträge.</p>
<p>Diese sind prinzipiell im Rahmen der Projektziele jederzeit änderbar oder löschbar. Wenden Sie sich gegebenenfalls
bitte über das <a href="https://{$http_host}/contact.php">Kontaktformular</a> an uns. Hierbei behalten wir uns aber Einschränkungen vor,
sofern Konflikte mit den Projektzielen bestehen. Dies sind insbesondere Lizenzkonflikte (die Veröffentlichung der Fotografien
erfolgt über eine <a href="https://creativecommons.org/licenses/by-sa/2.0/">Creative-Commons-Lizenz</a>), es soll aber
auch vermieden werden, dass gemeinsam erstellte Beiträge zerstückelt oder anderweitig entwertet werden.</p>
<h4>Cookies</h4>
<p>Wir bieten registrierten Teilnehmern die Möglichkeit, sich automatisch einzuloggen.  Diese Funktion erfordert
das Anlegen eines weiteren Cookies.
</p>
</div>
<h2 id="dsg">Detaillierte Datenschutzerklärung</h2>
...
<span class="tsmcontroller"></span><table>
	<tbody><tr>
		<td>Name</td>
	...
	<tr>
		<td>Leitzahl Deutsche&nbsp;Post&nbsp;AG</td>
		<td>71723</td>
	</tr>
	<tr>
		<td>Rufnummer Fernsprechanschluss</td>
		<td>90&nbsp;01&nbsp;00</td>
	</tr>
	<tr>
		<td>Vorwahl Deutsche&nbsp;Telekom&nbsp;AG</td>
		<td>0&nbsp;71&nbsp;48</td>
	</tr>
	<tr>
		<td>Elektronische Post</td>
		<td>hjlipp@web.de</td>
	</tr></tbody>
</table>
	<p>Aus der Tatsache, dass wir ein kleines Privatprojekt sind, das
	von wenigen Freiwilligen getragen wird, ergibt sich, dass wir
	am zuverlässigsten und schnellsten online erreichbar sind.
	<br /><b>Der bevorzugte Weg der Kontaktaufnahme ist daher
	<a href="https://{$http_host}/contact.php">das Kontaktformular</a> oder eine direkte
	<a href="mailto:hjlipp@web.de">E-Mail an Hansjörg&nbsp;Lipp&nbsp;&lt;hjlipp@web.de&gt;</a>.</b>
	</p><p>
	<a href="/help/legal_notice">Impressum</a></p>
<h3 id="dsg-general-datatype">Arten der verarbeiteten Daten:</h3>
	<ul>
		<li>Bestandsdaten (Name, Nickname, ...)</li>
		<li>Kontaktdaten (E-Mail)</li>
		<li>Inhaltsdaten (Texteingaben, Fotografien, ...)</li>
...
<h3 id="dsg-general-datasubjects">Kategorien betroffener Personen</h3>
	<p>Besucher und Nutzer des Onlineangebotes (Nachfolgend bezeichnen wir die betroffenen Personen zusammenfassend auch als &bdquo;Nutzer&ldquo;).
<br />
</p>
...
<br />
<br />
&bdquo;Verarbeitung&ldquo; ist jeder mit oder ohne Hilfe automatisierter Verfahren ausgeführte Vorgang oder jede solche Vorgangsreihe im Zusammenhang mit personenbezogenen Daten. Der Begriff reicht weit und umfasst praktisch jeden Umgang mit Daten.
<br />
<br />
&bdquo;Pseudonymisierung&ldquo; die Verarbeitung personenbezogener Daten in einer Weise, dass die personenbezogenen Daten ohne Hinzuziehung zusätzlicher Informationen nicht mehr einer spezifischen betroffenen Person zugeordnet werden können, sofern diese zusätzlichen Informationen gesondert aufbewahrt werden und technischen und organisatorischen Maßnahmen unterliegen, die gewährleisten, dass die personenbezogenen Daten nicht einer identifizierten oder identifizierbaren natürlichen Person zugewiesen werden.
<br />
<br />
&bdquo;Profiling&ldquo; jede Art der automatisierten Verarbeitung personenbezogener Daten, die darin besteht, dass diese personenbezogenen Daten verwendet werden, um bestimmte persönliche Aspekte, die sich auf eine natürliche Person beziehen, zu bewerten, insbesondere um Aspekte bezüglich Arbeitsleistung, wirtschaftliche Lage, Gesundheit, persönliche Vorlieben, Interessen, Zuverlässigkeit, Verhalten, Aufenthaltsort oder Ortswechsel dieser natürlichen Person zu analysieren oder vorherzusagen.
<br />
<br />
Als &bdquo;Verantwortlicher&ldquo; wird die natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle, die allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten entscheidet, bezeichnet.
<br />
<br />
&bdquo;Auftragsverarbeiter&ldquo; eine natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle, die personenbezogene Daten im Auftrag des Verantwortlichen verarbeitet.
<br />
</p>
...
<p></p>
<p><span class="ts-muster-content">Die Nachfolgekommentare können durch registrierte Nutzer mit deren Einwilligung gem. Art. 6 Abs. 1 lit. a DSGVO abonniert werden. Nutzer können laufende Kommentarabonnements jederzeit abbestellen. Die Bestätigungsemail wird Hinweise zu den Widerrufsmöglichkeiten enthalten. Für die Zwecke des Nachweises der Einwilligung der Nutzer, speichern wir den Anmeldezeitpunkt nebst der IP-Adresse der Nutzer und löschen diese Informationen, wenn Nutzer sich von dem Abonnement abmelden.
	<br />
	<br />
	Sie können den Empfang unseres Abonnemenets jederzeit kündigen, d.h. Ihre Einwilligungen widerrufen.</span></p>
<p></p>
<h3 id="dsg-gravatar">Abruf von Profilbildern bei Gravatar</h3>
<p></p>
<p><span class="ts-muster-content">Wir setzen innerhalb unseres Onlineangebotes und insbesondere im Blog den Dienst Gravatar der Automattic Inc., 60 29th Street #343, San Francisco, CA 94110, USA, ein.
	<br />
	<br />
	Gravatar ist ein Dienst, bei dem sich Nutzer anmelden und Profilbilder und ihre E-Mailadressen hinterlegen können. Wenn Nutzer mit der jeweiligen E-Mailadresse auf anderen Onlinepräsenzen (vor allem in Blogs) Beiträge oder Kommentare hinterlassen, können so deren Profilbilder neben den Beiträgen oder Kommentaren dargestellt werden. Bei uns wird dieser Dienst ausschließlich auf den Profilseiten der registrierten Nutzer genutzt. Hierzu wird, sofern ausdrücklich gewünscht, die von den Nutzern mitgeteilte E-Mailadresse an Gravatar zwecks Prüfung, ob zu ihr ein Profil gespeichert ist, verschlüsselt übermittelt. Dies ist der einzige Zweck der Übermittlung der E-Mailadresse und sie wird nicht für andere Zwecke verwendet, sondern danach gelöscht.
	<br />
	<br />
	...
	<br />
	<br />
	Wenn Nutzer nicht möchten, dass ein mit Ihrer E-Mail-Adresse bei Gravatar verknüpftes Benutzerbild in den Kommentaren erscheint oder dass die eigene E-Mailadresse an Gravatar übersendet wird,
	sollten Sie diese Funktion in ihren Profileinstellungen wieder deaktivieren.
	</span></p>
<p></p>
...
<p></p>
<p><span class="ts-muster-content">Wir setzen innerhalb unseres Onlineangebotes auf Grundlage unserer berechtigten Interessen (d.h. Interesse an der Analyse, Optimierung und wirtschaftlichem Betrieb unseres Onlineangebotes im Sinne des Art. 6 Abs. 1 lit. f. DSGVO) Inhalts- oder Serviceangebote von Drittanbietern ein, um deren Inhalte und Services, wie z.B. Videos oder Schriftarten einzubinden (nachfolgend einheitlich bezeichnet als &ldquo;Inhalte&ldquo;). 
	<br />
	<br />

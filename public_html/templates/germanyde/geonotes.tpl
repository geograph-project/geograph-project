...
alt="Creative Commons Licence [Some Rights Reserved]" src="/img/somerights20.gif" /></a> &nbsp; &copy; Copyright <a title="Profil betrachten" href="{$image->profile_link}">{$image->realname|escape:'html'}</a> und  
...
{/if}
{if $readonly}
		<input id="toggletexts" type="button" value="Bildbeschreibung verbergen" onclick="toggleTexts('Bildbeschreibung verbergen','Bildbeschreibung zeigen');" /> |
{else}

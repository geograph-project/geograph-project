...
{include file="_std_begin.tpl"}
 ...
 <li><a href="http://www.hlipp.de/contact.html">Impressum</a><br/><br/></li>
...
<ul>
	...
	<li><a title="Geotrips" href="/geotrips/?max=-1">view <b>trip reports</b> by our members</a></li>
...
<ul>
   ...
   <li>Fully Geographed: <ul>
	...
	<li>Breakdown by: <ul>
	   ...
	   <a href="/statistics/breakdown.php?by=level7">County</a>,
	   <a href="/statistics/breakdown.php?by=level4">State</a>, <br/>

...
<h2><a name="top"></a><img src="{dynamic}{$curproto}{/dynamic}www.gravatar.com/avatar/{$profile->md5_email}?r=G&amp;d={dynamic}{$curproto}{/dynamic}www.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536%3Fs=30&amp;s=50" alt="{$profile->realname|escape:'html'}s Gravatar" style="vertical-align:middle;padding-right:10px"/>Profil für {$profile->realname|escape:'html'}</h2>
...
{if $userimages}
	...
	<ul>
		...
		<li><b>Karten</b>: {if $profile->stats.images gt 10}<a href="/profile/{$profile->user_id}/map" rel="nofollow">Persönliche Geograph-Karte</a> (<a href="/profile/{$profile->user_id}/mmap" rel="nofollow">zonenlos</a>) oder {/if} aktuelle Fotos auf <a href="http://maps.google.de/maps?q=http://{$http_host}/profile/{$profile->user_id}/feed/recent.kml&amp;ie=UTF8&amp;om=1">Google Maps</a></li>

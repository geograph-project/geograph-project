...
{if $userimages}
	...
	<ul>
		...
		<li><b>Karten</b>: {if $profile->stats.images gt 10}<a href="/profile/{$profile->user_id}/map" rel="nofollow">Persönliche Geograph-Karte</a> (<a href="/profile/{$profile->user_id}/mmap" rel="nofollow">neue Version</a>) oder {/if} aktuelle Fotos auf <a href="http://maps.google.de/maps?q=http://{$http_host}/profile/{$profile->user_id}/feed/recent.kml&amp;ie=UTF8&amp;om=1">Google Maps</a></li>

...
{/if}
 ...
 {if $recentcount}
  	...
  	<h3 {if $overview} style="padding-top:15px; border-top: 2px solid black; margin-top: 15px;"{/if}>Lluniau diweddar <small>[<a href="/finder/recent.php" title="Show the most recent submissions">mwy...</a>]</small></h3>
	  ...
	  am sgw&acirc;r <a title="view page for {$image->grid_reference}" href="/gridref/{$image->grid_reference}">{$image->grid_reference}</a>

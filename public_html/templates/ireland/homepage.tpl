...
<div class="interestBox">
        <b>Geograph Ireland</b> is a currently sub-project of {external href="http://www.geograph.org.uk/" text="Geograph Britain and Ireland"} which collects photos of Great Britain <b>and</b> Ireland, the two sites share a common database for now. Photos submitted to one will be available on the other. Geograph Ireland is likely to become a totally separate entity.
</div>

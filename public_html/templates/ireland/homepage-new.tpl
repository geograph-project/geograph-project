...
<h2 style="text-align:center">Welcome to Geograph Ireland</h2>
...
The Geograph Ireland project aims to collect geographically
...
<div style="text-align:center;font-size:0.9em;padding:5px;margin:10px;background-color:yellow">Don't like the new layout? Please consider <a href="https://spreadsheets.google.com/viewform?formkey=dE16ckhUQ0Fjd2ZvMlVyUVNFc1l0UWc6MQ">giving us feedback</a> - <b>Thank You</b>!</div>
...
<script type="application/ld+json">
{
   ...
   "@type": "WebSite",
   "url": "http://www.geograph.ie/",
   "potentialAction": {
     "@type": "SearchAction",
     "target": "http://www.geograph.ie/of/{search_term}",

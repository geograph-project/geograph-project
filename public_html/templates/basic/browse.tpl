	...
	{if $totalimagecount}
		...
		<dl class="browselist">
			...
			{if $square->reference_index eq 1}
				...
				&middot;&nbsp;{external href="http://www.multimap.com/maps/?title=[`$urltitle`]+on+geograph.org.uk#t=l&map=$lat,$long|14|4&dp=841&loc=GB:$lat:$long:14|$urltitle|$urltitle" text="multimap.com"}
			{else}

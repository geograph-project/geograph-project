...
This pages shows all the steps from the <a href="/submit.php?redir=false">main submission process</a>, on one long page. Most of the functionality and buttons won't work, just for demonstration purposes. 
</div>
<br/>
<br/>
<br/>
...
<br/>
    ...
    <form enctype="multipart/form-data" action="about:blank" method="post" name="theForm" onsubmit="return false" {if $step ne 1}style="background-color:#f0f0f0;padding:5px;margin-top:0px; border:1px solid #d0d0d0;"{/if}>
...
{dynamic}{$status_message}{/dynamic}
	...
	<div style="background-color:pink; color:black; border:2px solid red; padding:10px; margin-bottom:20px"><b>First time here?</b> If so you might like to have a look at our <a href="/faq3.php?q=submit">FAQs</a>, or <a href="/ask.php">ask a question</a>.</div>
...
<div style="position:relative;">
	...
	<div style="position:relative;{if $tab != 1}display:none{/if}" class="interestBox" id="div1">
		...
		&nbsp;&nbsp;&nbsp;
		<input type="submit" name="setpos" value="Next &gt;"/> </p>
	</div>
	...
	<div style="position:relative;{if $tab != 2}display:none{/if}" class="interestBox" id="div2">
		...
		&nbsp;&nbsp;&nbsp;
		<input type="submit" name="setpos2" value="Next &gt;"/> </p>
	</div>

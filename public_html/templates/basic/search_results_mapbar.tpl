...
{/literal}{foreach from=$engine->results item=image}
	...
	olmap.images[{$image->gridimage_id}] = createMarker({$image->gridimage_id}, markerPoint, markerIcon, {$image->title|latin1_to_utf8|json_encode}, {$image->realname|latin1_to_utf8|json_encode});

...
{$status_message}{/dynamic}
	...
	&middot; <label for="service">Preferred Map service in Step 2:</label> <select name="service" id="service" onchange="saveService(this);clicker(2,false); clicker(2,true);">
...
<!-- # -->
	...
	<div id="sd1" class="sd" style="display:block">
		<iframe src="/submit2.php?inner&amp;step={dynamic}{if $multi}0{else}1{/if}{if $transfer_id}&amp;transfer_id={$transfer_id|escape:'url'}{/if}{/dynamic}&amp;container=iframe1" id="iframe1" width="100%" height="220px" style="border:0"></iframe>
	</div>
<!-- # -->

...
{include file="_std_begin.tpl"}
    ...
    <h2>Overview Statistics for Geograph Channel Islands</h2>
...
{/foreach}
   ...
   Graph: <a href="/statistics/photos_per_square.php">Gridsquares</a>, <a href="/statistics/hectads.php">Hectad</a> Coverage</p>

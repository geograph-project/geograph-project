...
{/if}
			...
			<table style="font-weight:bold;text-align:center" cellspacing="0" border="1" bordercolor="#cccccc" cellpadding="0">
				...
				<tr>
					...
					<td valign="top"><div class="interestBox">{$preview_width} x {$preview_height}</div><br/>
					<a href="/reuse.php?id={$image->gridimage_id}&amp;download={$image->_getAntiLeechHash()}"><img src="{$preview_url}" width="{$preview_width/$ratio}" height="{$preview_height/$ratio}" crossorigin="use-credentials" onerror="retryCross(this)"/></a><br/><br/>
					</td>
				...
				{if basename($image->altUrl) != "error.jpg"}
					...
					<td valign="top"><div class="interestBox">{$resized_width} x {$resized_height}</div><br/>
					<a href="/reuse.php?id={$image->gridimage_id}&amp;download={$image->_getAntiLeechHash()}&amp;size=640"><img src="{$preview_url}" width="{$resized_width/$ratio}" height="{$resized_height/$ratio}" crossorigin="use-credentials" onerror="retryCross(this)"/></a>
					</td>
				{/if}
				...
				{if $original_width > 800 || $original_height > 800}
					...
					<td valign="top"><div class="interestBox">{$resized_width} x {$resized_height}</div><br/>
					<a href="/reuse.php?id={$image->gridimage_id}&amp;download={$image->_getAntiLeechHash()}&amp;size=800"><img src="{$preview_url}" width="{$resized_width/$ratio}" height="{$resized_height/$ratio}" crossorigin="use-credentials" onerror="retryCross(this)"/></a>
					</td>
				{/if}
				...
				{if $original_width > 1024 || $original_height > 1024}
					...
					<td valign="top"><div class="interestBox">{$resized_width} x {$resized_height}</div><br/>
					<a href="/reuse.php?id={$image->gridimage_id}&amp;download={$image->_getAntiLeechHash()}&amp;size=1024"><img src="{$preview_url}" width="{$resized_width/$ratio}" height="{$resized_height/$ratio}" crossorigin="use-credentials" onerror="retryCross(this)"/></a>
					</td>
				{/if}
				

					<td valign="top"><div class="interestBox">{$original_width} x {$original_height}</div><br/>
					<a href="/reuse.php?id={$image->gridimage_id}&amp;download={$image->_getAntiLeechHash()}&amp;size=original"><img src="{$preview_url}" width="{$original_width/$ratio}" height="{$original_height/$ratio}" crossorigin="use-credentials" onerror="retryCross(this)"/></a>

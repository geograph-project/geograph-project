{assign var="page_title" value="Tag Search"}
{if $inner}
...
{if !$inner}
	<h2><a href="/finder/">Finder</a> :: Tags</h2>
...
{foreach from=$results item=item}
	<li><b><a href="/tagged/{$item.tag|escape:'urlplus'}" target="_top">{$item.tag|capitalizetag|escape:'html'|default:'unknown'}</a></b>
...
{if $query_info}
	...
	<a href="/search.php?text=@tags+{$q|escape:'url'}">Try viewing all these images together in image search</a>
{/if}

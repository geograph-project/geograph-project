{assign var="page_title" value="$adm1_name :: `$references.$ri` :: $total Geograph Photos"}
{assign var="meta_description" value="$total Creative Commons licensed photos of $adm1_name, `$references.$ri`"}

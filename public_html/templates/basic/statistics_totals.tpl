...
<ul>
<li><b>{$count.gridimage|thousends}</b> Photographs (<b>{$count.gridimage_search|thousends}</b> available)<ul>
...
<li><b>{$count.loc_ppl|thousends}</b> v2 gazetteer placenames</li>
...
<li><b>{$files.tpcache|thousends}</b> different rendered pages</li>
</ul>

...
<ul>
  <li>
    <form method="get" action="/flickr.php">
      <div id="searchfield"><label for="searchterm">Search</label>
        ...
        <br/><br/>
      <small>Enter a placename, postcode, grid reference, or text</small></div>
    </form>
  </li>
  ...
  <li><i>The images found by this page are neither endorsed nor controlled by Geograph.org.uk, please ensure you check the licence of the images before copying.</i><br/><br/></li>

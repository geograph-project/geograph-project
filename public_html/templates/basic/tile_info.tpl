...
{/literal}</style>
<table cellspacing=0 cellpadding=0 border=0 width="100%" onclick="window.parent.location.href='{$canonical_domain}/photo/{$image->gridimage_id}';" style="cursor:pointer">
	<tr>
		<td valign="top" align="center" width=240 style="padding:3px">
	                <a href="{$canonical_domain}/photo/{$image->gridimage_id}">{$image->getThumbnail(213,160)}</a><br><br>

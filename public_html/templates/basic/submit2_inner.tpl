...
{if $step eq 0}
	<div class="interestBox" style="float:right;width:auto;">&middot; {$data|@count} image(s) for submission<br/>&middot; <a href="/submit-multi.php" target="_top">Upload a batch of images</a><br/>

...
{/if}	
 ...
 {if $recentcount}
  	...
  	<h3 {if $overview} style="padding-top:15px; border-top: 2px solid black; margin-top: 15px;"{/if}><a href="search.php?i=1522" title="Show the most recent submissions">Recent Photos</a></h3>

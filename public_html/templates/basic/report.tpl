...
{dynamic}
    <tr>
        ...
        <td>
            ...
            <input type="text" name="name" size="25" value="{$user->realname|escape:'html'}" required>
    ...
    <tr>
        ...
        <td>
                <input type="email" name="email" size="25" value="{$user->email|escape:'html'}" required>
...
{/dynamic}
    ...
    <tr>
        <th>Subject:</th>
        <td>
            <input type="text" name="subject" size="35" value="Report a concern" required>
            &nbsp;<font class="error">*&nbsp;</font>
        </td>
    </tr>
    <tr>
        ...
        <td>
              <textarea name="message" cols="35" rows="8" wrap="soft" style="width:85%" placeholder="enter your message here" required></textarea>

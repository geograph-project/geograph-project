...
<br/>
<b>Others</b>
<a title="show the contributor depth" href="/mapsheet.php?t={$mosaic_token}&amp;levels=1{dynamic}{if $gridref_from}&amp;gridref_from={$gridref_from}{/if}{/dynamic}">contributor depth</a><br/>

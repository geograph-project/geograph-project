...
<h2>Submitting to Geograph!</h2>

<ul>
<li>We are currently transitioning from the outdated category submission ti a newer tags based method. <a href="/switch.php">Read More (and switch)</a></li>
</ul>
<br/>
...
<tr>
	<td align="center">
		<b style="font-size:1.2em"><a href="/submit.php?redir=false">Original Submission method</a></b><br/><br/>
		The original, and longest established process - recommended for first time users.
	</td>
</tr>
<tr>
	<td align="center">
		<b style="font-size:1.2em"><a href="/submit2.php">Submission v2</a></b>  (<a href="/submit2.php?display=tabs">Tabs</a>)<br/><br/>
...
<tr>
	<td align="center">
		...
		Upload multiple files to server in one go. The continue via v1 or v2 to actully submit the photos
	</td>
</tr>
<tr>
	<td align="center">
...
<tr>
	<td align="center">
		...
		<small>Quick links:
                &middot; <a href="/article/edit.php?page=new">Article</a>
                &middot; <a href="/discuss/?action=vtopic&forum=11">Gallery</a>
                &middot; <a href="/blog/edit.php?id=new">Blog Entry</a>
                &middot; {external href="http://users.aber.ac.uk/ruw/misc/geotrip_submit.php" text="GeoTrip"}
                &middot;</small><br/><br/>
		This page details the various areas we have where users can contribute content, this includes textual articles and collections of photos. <br/>
	</td>
</tr>
<tr>
	<td align="center" colspan="2">
		{external href="http://media.geograph.org.uk/" text="Media Upload"}<br/><br/>
		Dedicated hosting for drawings, files, and other media used to accompany geograph submissions (eg drawings for incorperation into articles.
	</td>
</tr>
</table>

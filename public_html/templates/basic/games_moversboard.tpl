...
<table class="report"> 
<thead><tr><td>Position</td><td>Name</td><td>Pineapples</td><td>Games</td></tr></thead>
<tbody>
...
<tr class="totalrow"><th>&nbsp;</th><th>Totals</th><th align="right">{$score}</th><th align="right">{$games}</th></tr></thead>
</tbody>
</table>

{assign var="page_title" value="New Contributor Information"}
{include file="_std_begin.tpl"}

<div align="center" class="tabHolder">
        <a href="/article/About-Geograph-page" class="tab">About</a>
        <a href="/help/new_contributors" class="tabSelected">New Contributor</a>
        <a href="/content/documentation.php" class="tab">General</a>
</div>
<div style="position:relative;" class="interestBox">
        <h2 style="margin:0">Contributor Information</h2>
</div>

...
<p style="margin-left:auto;margin-right:auto;width:600px" id="blogcontent">{$content|nl2br|GeographLinks:true|regex_replace:'/(height|width)="\d+"/':'$1="14"'}</p>
...
<div style="float:right; position:relative; padding:5px; border:1px solid gray; ">
	<div style="width:450px; height:400px;" id="map">Loading map...</div>
...
{literal}
	<script>
	$(function() {
		$('#blogcontent img').jqueryzoom({
				xzoom: 120, //zooming div default width(default width value is 200)
				yzoom: 120, //zooming div default width(default height value is 200)

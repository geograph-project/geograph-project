...
<div style="float:left; font-size:0.9em">From: <a href="{$self_host}/">{$http_host}</a></div><div style="text-align:right; font-size:0.9em">Generated {$generated|default:$smarty.now|date_format:"%A, %B %e, %Y at %H:%M"}</div></div>
</div>

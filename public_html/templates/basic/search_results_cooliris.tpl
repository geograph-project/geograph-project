...
{if $engine->resultCount}
	...
	{/if}
	<p>&middot; <a href="http://www.cooliris.com/tab/#cs=11&url={$self_host}{$rss_url|escape:'url'}">Open in Cooliris Plugin</a> <small>You may be prompted to install the plugin</small>

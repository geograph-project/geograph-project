...
<div class="{if $image->isLandscape()}photolandscape{else}photoportrait{/if}">
  ...
  <div class="shadow shadow_large" id="mainphoto">{$image->getFull(true,'basic',$larger)|replace:'/>':' itemprop="contentURL url"/>'}<meta itemprop="representativeOfPage" content="true"/></div>
...
-->
<meta itemprop="copyrightNotice" content="{$image->realname|escape:'html'}">
</div>
...
<td colspan="6" align="center" style="padding:5px;border-bottom:1px solid gray;font-size:0.8em;">
	...
	<a title="Share this photo via email/e-card" href="/ecard.php?image={$image->gridimage_id}"><img src="{$static_host}/img/email_16.png" width="16" height="16" style="vertical-align:middle" alt="email icon"/></a> &middot;

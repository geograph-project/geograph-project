...
function unloadMess() {
	var ele = document.forms['theForm'].elements['title'];
...
<div class="field">
	...
	<input type="text" name="title" value="{$title|escape:"html"}" maxlength="64" style="width:100%"/>
...
<div class="field">
	...
	<input type="text" name="url" value="{$url|escape:"html"}" maxlength="255" style="width:100%"/></span>
...
<div class="field">
	...
	<input type="text" name="grid_reference" value="{$grid_reference|escape:"html"}" maxlength="12" style="width:100%"/>
...
<div class="field">
	...
	<input type="text" name="gridimage_id" value="{$gridimage_id|escape:"html"}" maxlength="12" style="width:100%"/>
...
<div class="field">
	...
	<input type="text" name="description" value="{$description|escape:"html"}" maxlength="255" style="width:100%"/>

...
{if $recipient->registered}
	...
	{if $dev}
		<div class="interestBox" style="background-color:orange;margin:10px;padding:10px">
	...
	{else}
		...
		<div class="interestBox">
			...
			<textarea rows="10" cols="60" name="msg" class="full-width" id="msg"{if $user->message_sig} onfocus="if (this.value=='') {literal}{{/literal}this.value='{$user->message_sig|escape:'javascript'}';setCaretTo(this,0); {literal}}{/literal}"{/if}>{$msg|escape:'html'}</textarea>
			<br/>

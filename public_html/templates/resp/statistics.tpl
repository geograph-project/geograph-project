...
<hr>
<h3><a name="gravity"></a>Centre of gravity</h3>

{if $overview2}
<div style="float:left; width:{$overview2_width+30}px; position:relative; clear:both">

<div class="map" style="margin-left:20px;border:2px solid black; height:{$overview2_height}px;width:{$overview2_width}px">

<div class="inner" style="position:relative;top:0px;left:0px;width:{$overview2_width}px;height:{$overview2_height}px; clear:both">
...
<hr>
<h3><a name="more"></a>LeaderBoards</h3>
...
<h3>Covering the squares</h3><sup><a href="/help/squares" class="about" style="font-size:0.7em">?</a></sup>
...
<hr>
<h3>More Technical Database Stats</h3>
</div>

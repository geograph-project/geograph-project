...
.forum-finder-grid {
  display: grid;
  grid-template-areas:
    'forum-finder-results forum-finder-images'
    'forum-finder-guide forum-finder-guide';
...
.forum-finder-results {
  grid-area: forum-finder-results;
  width: 100%;
}
.forum-finder-guide {
  grid-area: forum-finder-guide;
  width: 100%;
}
.forum-finder-images {
...
<div class="forum-finder-grid">
<div class="forum-finder-results">
...
<div class="forum-finder-images">
{if $results && !$grouped}
	<b>Image Results</b>
	<iframe src="/finder/search-service.php?q={$q|escape:'url'}&amp;mode=1" width=100% height=100% style="border:0"></iframe>
  <br style="clear:both"/>
{/if}
</div>
<div class="forum-finder-guide">

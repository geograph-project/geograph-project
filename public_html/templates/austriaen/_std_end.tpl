 ...
 <div class="nav">
  <ul>
    ...
    <li>View<ul>
     ...
     <li><a title="View map of all submissions" href="/mapbrowse.php">Map</a>
        (<a title="Map without zones" href="/mapbrowse2.php?mt=tm">no zones</a>)</li>
...
{/if}
  <div id="footer" class="no_print">
   ...
   <p><a href="/help/sitemap" title="Listing of site pages">Sitemap</a>
       ...
       <span class="sep">|</span>
       <a href="http://jigsaw.w3.org/css-validator/validator?uri=http://{$static_host}/templates/austriaen/css/basic.css" title="check our css standards compliance">CSS</a>
    </p>
  </div>
</div>
</body>

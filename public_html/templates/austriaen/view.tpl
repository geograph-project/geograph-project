...
{if $image->grid_square->reference_index eq 1}OSGB36{elseif $image->grid_square->reference_index eq 2}Irish{elseif $image->grid_square->reference_index eq 6}MGRS 32{elseif $image->grid_square->reference_index eq 7}MGRS 33{/if}: <img src="//{$static_host}/img/geotag_16.png" width="10" height="10" alt="geotagged!" style="vertical-align:middle;" /> <a href="/gridref/{$image->subject_gridref}/links">{$image->subject_gridref_spaced}</a> [{$image->subject_gridref_precision}m precision]<br/>

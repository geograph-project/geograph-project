    ...
    */
    update: function() {
        ...
        */
        ...
        var xLabelPos = Math.floor((mapTrBounds.right - llInterval) / llInterval) * llInterval;
...
/** 
* APIFunction: UKOSGraticule
* constructor that builds a new OpenLayers.Control.KmGraticule for the UK OS Grid 
*/

OpenLayers.Control.UKOSGraticule = function () {
    return new OpenLayers.Control.KmGraticule("EPSG:27700", [0, 0, 700000, 1300000], { maxInterval: 100000, visible: true, layerName: "OSGB Grid" });
};

/** 
* APIFunction: IrishGraticule
* constructor that builds a new OpenLayers.Control.KmGraticule for the Irish Grid 
*/

OpenLayers.Control.IrishGraticule = function () {
    return new OpenLayers.Control.KmGraticule("EPSG:29902", [0, 0, 400000, 500000], { maxInterval: 100000, visible: true, layerName: "Irish Grid" });
};

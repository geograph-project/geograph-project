...
$data= $db->getAll("SELECT gridimage_id,title,comment,imageclass,grid_reference,user_id,realname FROM gridimage_search ORDER BY gridimage_id DESC LIMIT 100");

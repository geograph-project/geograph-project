...
require_once('geograph/imagelist.class.php');
	...
	$sql = " select gridimage_id,showday,title,realname,user_id,original_width,original_height,grid_reference,imagetaken
	 from gridimage_daily inner join gridimage_size using (gridimage_id) inner join gridimage_search using (gridimage_id)
	 where showday < now() and showday is not null and original_width > 800 and imagetaken < date_sub(now(),interval 10 year) order by showday desc limit 10";

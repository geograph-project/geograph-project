...
$db = GeographDatabaseConnection(false);
	...
	dump_sql_table(" select t.*,count(gridimage_id) from tag t left join category_primary on (t.tag = top) left join gridimage_tag using (tag_id) where prefix = 'top' and grouping is null and t.status = 1 group by tag_id",'Unoffical Context');

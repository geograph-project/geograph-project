...
/**
 * $Project: GeoGraph $
 * $Id: gridbuilder.php 2872 2007-01-06 22:27:07Z barry $
 * 
...
if (isset($_POST['shader']))
{
	...
	$shader->process($imgfile, $shader_x, $shader_y, $reference_index, $clearexisting, !$skipupdategridprefix,$redrawmaps,$ignore100);

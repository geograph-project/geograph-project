    ...
    <div class="disclaimer-card">
        ...
        <div class="disclaimer-text">
            ...
            <ul>
                ...
                <li><strong>Generic Browsers Excluded:</strong> Strings identified as standard, uncustomized desktop or mobile web browsers are not cataloged in this archive. (althoguh a few might slip though!)</li>
                <li><strong>API Traffic Included:</strong> This data logs all user agents accessing the website through any channel, including requests via authorized APIs (with or without a key!), it is not purely a record of scraping or crawling attempts.</li>
                ...
                <?php while ($row = $results->FetchRow()): ?>
                    <tr>
                        ...
                        <?php else: ?>
                            ...
                            <td class="ua-string"><?= str_replace($row['fragment'],'<b>'.$row['fragment'].'</b>',htmlspecialchars($row['useragent'], ENT_QUOTES)) ?></td>
                        <?php endif; ?>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>

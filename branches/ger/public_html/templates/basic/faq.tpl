...
<h3>Do you have an RSS feed?</h3>
	...
	<div>We have recently added RSS feeds to other parts of the site:
		<ul>
			...
			<li>the Grid Square Discussions even supports <a class="xml-geo" title="Geograph Grid Square Discussions" href="http://{$http_host}/discuss/syndicator.php?forum={$forum_gridsquare}&amp;format=GeoRSS">GeoRSS</a>.</li>

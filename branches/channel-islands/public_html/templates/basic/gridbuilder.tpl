...
<label for"reference_index">Grid Reference Index (1=GB 2=Irish, 6=Channel Islans):</label> <input size="1" type="text" id="reference_index" name="reference_index" value="{$reference_index}"/><br />

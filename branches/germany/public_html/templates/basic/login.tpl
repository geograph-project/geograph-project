...
{if count($_post) && !$_post.login}
	<br/><br/>
	<div class="interestBox"><sup style="color:red">new!</sup> Entering your details above should allow you to continue without loss of data. The exception is actually uploading an image, for example on Step 2 of the submission process, which will need to be resent. <br/><br/>

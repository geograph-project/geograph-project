...
alt="Creative Commons Licence [Some Rights Reserved]" src="/img/somerights20.gif" /></a> &nbsp; Image used on this page, &copy; Copyright <a title="View profile" href="{$game->image->profile_link}">{$game->image->realname|escape:'html'}</a> and  

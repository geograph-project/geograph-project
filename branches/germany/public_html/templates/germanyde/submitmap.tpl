...
<p style="font-size:small;margin:0px;padding:1px 0px">Bitte Karte anklicken um einen verschiebbaren Marker zu erzeugen...</p>
...
{dynamic}{if $ask_gmaps}<p style="font-size:small;margin:0px;padding:1px 0px"><a href="#" onclick="set_use_gmaps({$ask_gmaps_newval}, {$ask_gmaps_profile}, {$ask_gmaps_reload}); return false;">Ohne GoogleMaps</a> (<a href="/help/privacy">Datenschutz</a>)</p>{/if}{/dynamic}

...
if (!empty($_GET['topic']) && is_numeric($_GET['topic'])) {
	...
	$rss->title = "atgeo.hlipp.de Forum :: $title :: Latest Posts";
...
if (!$opt_noLimit) {
	...
	if ($opt_first) {
		$rss->title = "atgeo.hlipp.de Forum $title :: New Topics";
		...
		$rss->title = "atgeo.hlipp.de Forum $title :: Latest Topics";
		...
		$rss->title = "atgeo.hlipp.de Forum $title :: Latest Discussions";

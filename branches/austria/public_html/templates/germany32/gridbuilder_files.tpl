...
{if $limpland}<input type="hidden" id="limpland" name="limpland" value="1"/>{/if}
{if $createsquares}<input type="hidden" id="createsquares" name="createsquares" value="1"/>{/if}
{if $calcpercland}<input type="hidden" id="calcpercland" name="calcpercland" value="1"/>{/if}

...
{assign var="extra_css" value="/templates/germany32/css/marked.css"}
...
<div id="clipboard" class="clipboard"><!--
	...
	--><div id="dummyclip" class="dragitem clipboarddummy" style="width:213px;height:160px;"></div><div style="clear:both"></div><!--
--></div>

...
{if $token_zoomout}
	...
	<div class="cnr"></div>
	<div class="side" style="width:{$mosaic_width}px;"><a accesskey="W" title="Nach Norden (Alt+W)" href="/map2/{$token_north}"><img src="//{$static_host}/templates/basic/img/arrow_n.gif" alt="Nord" width="13" height="8"/></a></div>
	<div class="cnr"></div>


	<div class="side" style="height:{$mosaic_height}px;"><a accesskey="A" title="Nach Westen (Alt+A)" href="/map2/{$token_west}"><img style="padding-top:{$mosaic_height/2 - 4}px" src="//{$static_host}/templates/basic/img/arrow_w.gif" alt="West" width="8" height="13"/></a></div>
	...
	<div class="side" style="height:{$mosaic_height}px;"><a accesskey="D" title="Nach Osten (Alt+D)" href="/map2/{$token_east}"><img style="padding-top:{$mosaic_height/2 - 4}px" src="//{$static_host}/templates/basic/img/arrow_e.gif" alt="Ost" width="8" height="13"/></a></div>

	<div class="cnr"></div>
	<div class="side" style="width:{$mosaic_width}px;"><a accesskey="X" title="Nach Süden (Alt+X)" href="/map2/{$token_south}"><img src="//{$static_host}/templates/basic/img/arrow_s.gif" alt="Süd" width="13" height="8"/></a></div>
	<div class="cnr"></div>
	</div>
{else}
	<div class="map" style="height:{$mosaic_height+20}px;width:{$mosaic_width+20}px">
...
<table class="navtable" border="0" cellpadding="0" cellspacing="0" width="143">
  ...
  <tr><!-- row 2 -->
   ...
   <td>{if $token_zoomin}<a accesskey="S" title="Vergrößern (Alt+S)" href="/map2/{$token_zoomin}" onmouseout="di20('zoomin','/templates/austriade/mapnav/zoomin.gif');"  onmouseover="di20('zoomin','/templates/austriade/mapnav/zoomin_F2.gif');" ><img alt="Hereinzoomen" id="zoomin" src="//{$static_host}/templates/austriade/mapnav/zoomin.gif" width="30" height="29"/></a>{else}<img alt="Hereinzoomen" title="Weiter vergrößern nicht möglich!" id="zoomin" src="//{$static_host}/templates/austriade/mapnav/zoomin_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" id="fill1" src="//{$static_host}/templates/austriade/mapnav/fill1.gif" width="30" height="29"/></td>
   <td>{if $token_zoomout}<a accesskey="W" title="Nach Norden (Alt+W)" href="/map2/{$token_north}" onmouseout="di20('north','/templates/austriade/mapnav/north.gif');"  onmouseover="di20('north','/templates/austriade/mapnav/north_F2.gif');" ><img id="north" alt="Nach Norden" src="//{$static_host}/templates/austriade/mapnav/north.gif" width="30" height="29"/></a>{else}<img alt="Norden" title="Norden" id="north" src="//{$static_host}/templates/austriade/mapnav/north_F3.gif" width="30" height="29"/>{/if}</td>
  ...
  <tr><!-- row 3 -->
   ...
   <td>{if $token_zoomout}<a accesskey="A" title="Nach Westen (Alt+A)" href="/map2/{$token_west}" onmouseout="di20('west','/templates/austriade/mapnav/west.gif');"  onmouseover="di20('west','/templates/austriade/mapnav/west_F2.gif');"><img id="west" alt="Nach Westen" src="//{$static_host}/templates/austriade/mapnav/west.gif" width="30" height="29"/></a>{else}<img alt="Westen" title="Westen" id="west" src="//{$static_host}/templates/austriade/mapnav/west_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" id="fill4" src="//{$static_host}/templates/austriade/mapnav/fill4.gif" width="30" height="29"/></td>
   <td>{if $token_zoomout}<a accesskey="D" title="Nach Osten (Alt+D)" href="/map2/{$token_east}" onmouseout="di20('east','/templates/austriade/mapnav/east.gif');"  onmouseover="di20('east','/templates/austriade/mapnav/east_F2.gif');" ><img id="east" alt="Nach Osten" src="//{$static_host}/templates/austriade/mapnav/east.gif" width="30" height="29"/></a>{else}<img alt="Osten" title="Osten" id="east" src="//{$static_host}/templates/austriade/mapnav/east_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" src="//{$static_host}/templates/austriade/mapnav/shim.gif" width="1" height="29"/></td>
  </tr>
  ...
  <tr><!-- row 4 -->
   ...
   <td>{if $token_zoomout}<a accesskey="X" title="Nach Süden (Alt+X)" href="/map2/{$token_south}" onmouseout="di20('south','/templates/austriade/mapnav/south.gif');"  onmouseover="di20('south','/templates/austriade/mapnav/south_F2.gif');"><img id="south" alt="Nach Süden" src="//{$static_host}/templates/austriade/mapnav/south.gif" width="30" height="29"/></a>{else}<img alt="Süden" title="Süden" id="south" src="//{$static_host}/templates/austriade/mapnav/south_F3.gif" width="30" height="29"/>{/if}</td>

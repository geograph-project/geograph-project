...
{if $token_zoomout}
	...
	<div class="cnr"></div>
	<div class="side" style="width:{$mosaic_width}px;"><a accesskey="W" title="Pan map north (Alt+W)" href="/map2/{$token_north}"><img src="//{$static_host}/templates/basic/img/arrow_n.gif" alt="North" width="13" height="8"/></a></div>
	<div class="cnr"></div>


	<div class="side" style="height:{$mosaic_height}px;"><a accesskey="A" title="Pan map west (Alt+A)" href="/map2/{$token_west}"><img style="padding-top:{$mosaic_height/2 - 4}px" src="//{$static_host}/templates/basic/img/arrow_w.gif" alt="West" width="8" height="13"/></a></div>
	...
	{foreach from=$mosaic key=y item=maprow}
		...
		{/if}
		<a href="/mapbrowse2.php?t={$mosaic_token}&amp;i={$x}&amp;j={$y}&amp;zoomin=1"><img 
	...
	{foreach from=$mosaic key=y item=maprow}
		<div>
		{foreach from=$maprow key=x item=mapcell}
			{assign var="mapmap" value=$mapcell->getGridInfo()}
			...
			{*foreach from=$mapmap key=gx item=gridrow}
				...
				{/foreach}
			{/foreach*}
			{foreach from=$mapmap key=key item=gridcell}
				<area shape="poly" coords="{$gridcell.poly|@implode:','}" {if $gridcell.gridimage_id}{if $gridcell.imagecount > 1}href="/gridref/{$gridcell.grid_reference}"{else}href="/photo/{$gridcell.gridimage_id}"{/if} title="{$gridcell.grid_reference} : {$gridcell.title|escape:'html'} by {$gridcell.realname|escape:'html'} {if $gridcell.imagecount > 1}&#13;&#10;({$gridcell.imagecount} images in this square){/if}" alt="{$gridcell.grid_reference} : {$gridcell.title|escape:'html'} by {$gridcell.realname|escape:'html'} {if $gridcell.imagecount > 1}&#13;&#10;({$gridcell.imagecount} images in this square){/if}"{else} href="/gridref/{$gridcell.grid_reference}" alt="{$gridcell.grid_reference}" title="{$gridcell.grid_reference}"{/if}/>
			{/foreach}
			</map>
			{if $mosaic_clip}</div></div>{/if}
			{else}
	...
	<div class="side" style="height:{$mosaic_height}px;"><a accesskey="D" title="Pan map east (Alt+D)" href="/map2/{$token_east}"><img style="padding-top:{$mosaic_height/2 - 4}px" src="//{$static_host}/templates/basic/img/arrow_e.gif" alt="East" width="8" height="13"/></a></div>

	<div class="cnr"></div>
	<div class="side" style="width:{$mosaic_width}px;"><a accesskey="X" title="Pan map south (Alt+X)" href="/map2/{$token_south}"><img src="//{$static_host}/templates/basic/img/arrow_s.gif" alt="South" width="13" height="8"/></a></div>
	<div class="cnr"></div>
	</div>
{else}
	<div class="map" style="height:{$mosaic_height+20}px;width:{$mosaic_width+20}px">
...
{if $token_zoomout}
	{foreach from=$overview key=y item=maprow}
		...
		<div style="position:absolute;clip:rect({$mapcell->cliptop}px,{$mapcell->image_w-$mapcell->clipright}px,{$mapcell->image_h-$mapcell->clipbottom}px,{$mapcell->clipleft}px);top:-{$mapcell->cliptop}px;left:-{$mapcell->clipleft}px">
		{/if}
		{*<a href="/mapbrowse2.php?t={$mosaic_token}&amp;{if !$token_zoomin}o={$overview_token}&amp;{/if}i={$x}&amp;j={$y}&amp;recenter=1"><img *}
		<a href="/mapbrowse2.php?t={$mosaic_token}&amp;o={$overview_token}&amp;i={$x}&amp;j={$y}&amp;recenter=1"><img 
...
<table class="navtable" border="0" cellpadding="0" cellspacing="0" width="143">
  ...
  <tr><!-- Shim row, height 1. -->
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="12" height="1"/></td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="30" height="1"/></td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="30" height="1"/></td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="30" height="1"/></td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="30" height="1"/></td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="11" height="1"/></td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="1" height="1"/></td>
  </tr>

  <tr><!-- row 1 -->
   <td colspan="6"><img alt="" src="//{$static_host}/templates/austriaen/mapnav/top.gif" width="143" height="9"/></td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="1" height="9"/></td>
  </tr>

  <tr><!-- row 2 -->
   <td rowspan="6"><img alt="" src="//{$static_host}/templates/austriaen/mapnav/left.gif" width="12" height="211"/></td>
   <td>{if $token_zoomin}<a accesskey="S" title="Zoom in (Alt+S)" href="/map2/{$token_zoomin}" onmouseout="di20('zoomin','/templates/austriaen/mapnav/zoomin.gif');"  onmouseover="di20('zoomin','/templates/austriaen/mapnav/zoomin_F2.gif');" ><img alt="Zoom In" id="zoomin" src="//{$static_host}/templates/austriaen/mapnav/zoomin.gif" width="30" height="29"/></a>{else}<img alt="Zoom In" title="Can't zoom in any further" id="zoomin" src="//{$static_host}/templates/austriaen/mapnav/zoomin_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" id="fill1" src="//{$static_host}/templates/austriaen/mapnav/fill1.gif" width="30" height="29"/></td>
   <td>{if $token_zoomout}<a accesskey="W" title="Pan north (Alt+W)" href="/map2/{$token_north}" onmouseout="di20('north','/templates/austriaen/mapnav/north.gif');"  onmouseover="di20('north','/templates/austriaen/mapnav/north_F2.gif');" ><img id="north" alt="Pan North" src="//{$static_host}/templates/austriaen/mapnav/north.gif" width="30" height="29"/></a>{else}<img alt="North" title="North" id="north" src="//{$static_host}/templates/austriaen/mapnav/north_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" id="fill2" src="//{$static_host}/templates/austriaen/mapnav/fill2.gif" width="30" height="29"/></td>
   <td rowspan="6"><img alt="" src="//{$static_host}/templates/austriaen/mapnav/right.gif" width="11" height="211"/></td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="1" height="29"/></td>
  </tr>

  <tr><!-- row 3 -->
   <td><img alt="" id="fill3" src="//{$static_host}/templates/austriaen/mapnav/fill3.gif" width="30" height="29"/></td>
   <td>{if $token_zoomout}<a accesskey="A" title="Pan west (Alt+A)" href="/map2/{$token_west}" onmouseout="di20('west','/templates/austriaen/mapnav/west.gif');"  onmouseover="di20('west','/templates/austriaen/mapnav/west_F2.gif');"><img id="west" alt="Pan West" src="//{$static_host}/templates/austriaen/mapnav/west.gif" width="30" height="29"/></a>{else}<img alt="West" title="West" id="west" src="//{$static_host}/templates/austriaen/mapnav/west_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" id="fill4" src="//{$static_host}/templates/austriaen/mapnav/fill4.gif" width="30" height="29"/></td>
   <td>{if $token_zoomout}<a accesskey="D" title="Pan east (Alt+D)" href="/map2/{$token_east}" onmouseout="di20('east','/templates/austriaen/mapnav/east.gif');"  onmouseover="di20('east','/templates/austriaen/mapnav/east_F2.gif');" ><img id="east" alt="Pan East" src="//{$static_host}/templates/austriaen/mapnav/east.gif" width="30" height="29"/></a>{else}<img alt="East" title="East" id="east" src="//{$static_host}/templates/austriaen/mapnav/east_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="1" height="29"/></td>
  </tr>

  <tr><!-- row 4 -->
   <td>{if $token_zoomout}<a accesskey="Q" title="Zoom out (Alt+Q)" href="/map2/{$token_zoomout}" onmouseout="di20('zoomout','/templates/austriaen/mapnav/zoomout.gif');"  onmouseover="di20('zoomout','/templates/austriaen/mapnav/zoomout_F2.gif');"><img id="zoomout" src="//{$static_host}/templates/austriaen/mapnav/zoomout.gif" width="30" height="29" alt="Zoom Out"/></a>{else}<img alt="Zoom Out" title="Can't zoom out any further" id="zoomout" src="//{$static_host}/templates/austriaen/mapnav/zoomout_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" id="fill5" src="//{$static_host}/templates/austriaen/mapnav/fill5.gif" width="30" height="29"/></td>
   <td>{if $token_zoomout}<a accesskey="X" title="Pan south (Alt+X)" href="/map2/{$token_south}" onmouseout="di20('south','/templates/austriaen/mapnav/south.gif');"  onmouseover="di20('south','/templates/austriaen/mapnav/south_F2.gif');"><img id="south" alt="Pan South" src="//{$static_host}/templates/austriaen/mapnav/south.gif" width="30" height="29"/></a>{else}<img alt="South" title="South" id="south" src="//{$static_host}/templates/austriaen/mapnav/south_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" id="fill6" src="//{$static_host}/templates/austriaen/mapnav/fill6.gif" width="30" height="29"/></td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="1" height="29"/></td>
  </tr>

  <tr><!-- row 5 -->
   <td colspan="4"><img alt="" id="middle" src="//{$static_host}/templates/austriaen/mapnav/middle.gif" width="120" height="11"/></td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="1" height="11"/></td>
  </tr>
  ...
  <tr><!-- row 6 -->
   ...
   {if !$token_zoomin}
<form action="/map2/{$mosaic_token}" method="get">
<div>
 ...
 <br/>
   ...
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="1" height="103"/></td>
  </tr>

  <tr><!-- row 7 -->
   <td colspan="4"><img alt="" src="//{$static_host}/templates/austriaen/mapnav/bottom.gif" width="120" height="10"/></td>
   <td><img alt="" src="//{$static_host}/templates/austriaen/mapnav/shim.gif" width="1" height="10"/></td>
  </tr>
...
<!-- 
if (document.images) {
zoomin_F2 = new Image(30,29); zoomin_F2.src = "/templates/austriaen/mapnav/zoomin_F2.gif";
north_F2 = new Image(30,29); north_F2.src = "/templates/austriaen/mapnav/north_F2.gif";
west_F2 = new Image(30,29); west_F2.src = "/templates/austriaen/mapnav/west_F2.gif";
east_F2 = new Image(30,29); east_F2.src = "/templates/austriaen/mapnav/east_F2.gif";
zoomout_F2 = new Image(30,29); zoomout_F2.src = "/templates/austriaen/mapnav/zoomout_F2.gif";
south_F2 = new Image(30,29); south_F2.src = "/templates/austriaen/mapnav/south_F2.gif";
}
-->
</script>
{/literal}
...
{* {$gridref_param} {$gridref_ok} "/map2/{$mosaic_token}&amp;gridref=ABC1234" *}
...
<div class="tabHolder" style="margin-top:3px">
	Style: 
	<a class="tab{if $tab == 1}Selected{/if} nowrap" id="tab1" href="/map2/{$mosaic_token}?depth=0">Coverage</a>
	{dynamic}
	{if $realname}
		<a class="tab{if $tab == 2}Selected{/if} nowrap" id="tab2">Personalised</a>
	{elseif $user->registered}
		<a class="tab{if $tab == 2}Selected{/if} nowrap" id="tab2" href="/map2/{$mosaic_token}?mine"> Personalised</a>
	{/if}{/dynamic}
	{if $token_zoomin}
	<a class="tab{if $tab == 3}Selected{/if} nowrap" id="tab3" href="/map2/{$mosaic_token}?depth=1">Depth</a>
	{/if}

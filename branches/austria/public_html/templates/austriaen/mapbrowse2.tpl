...
<table class="navtable" border="0" cellpadding="0" cellspacing="0" width="143">
  ...
  <tr><!-- row 2 -->
   ...
   <td>{if $token_zoomin}<a accesskey="S" title="Zoom in (Alt+S)" href="/map2/{$token_zoomin}" onmouseout="di20('zoomin','/templates/basic/mapnav/zoomin.gif');"  onmouseover="di20('zoomin','/templates/basic/mapnav/zoomin_F2.gif');" ><img alt="Zoom In" id="zoomin" src="//{$static_host}/templates/basic/mapnav/zoomin.gif" width="30" height="29"/></a>{else}<img alt="Zoom In" title="Can't zoom in any further" id="zoomin" src="//{$static_host}/templates/basic/mapnav/zoomin_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" id="fill1" src="//{$static_host}/templates/basic/mapnav/fill1.gif" width="30" height="29"/></td>
   <td>{if $token_zoomout}<a accesskey="W" title="Pan north (Alt+W)" href="/map2/{$token_north}" onmouseout="di20('north','/templates/basic/mapnav/north.gif');"  onmouseover="di20('north','/templates/basic/mapnav/north_F2.gif');" ><img id="north" alt="Pan North" src="//{$static_host}/templates/basic/mapnav/north.gif" width="30" height="29"/></a>{else}<img alt="North" title="North" id="north" src="//{$static_host}/templates/basic/mapnav/north_F3.gif" width="30" height="29"/>{/if}</td>
  ...
  <tr><!-- row 3 -->
   ...
   <td>{if $token_zoomout}<a accesskey="A" title="Pan west (Alt+A)" href="/map2/{$token_west}" onmouseout="di20('west','/templates/basic/mapnav/west.gif');"  onmouseover="di20('west','/templates/basic/mapnav/west_F2.gif');"><img id="west" alt="Pan West" src="//{$static_host}/templates/basic/mapnav/west.gif" width="30" height="29"/></a>{else}<img alt="West" title="West" id="west" src="//{$static_host}/templates/basic/mapnav/west_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" id="fill4" src="//{$static_host}/templates/basic/mapnav/fill4.gif" width="30" height="29"/></td>
   <td>{if $token_zoomout}<a accesskey="D" title="Pan east (Alt+D)" href="/map2/{$token_east}" onmouseout="di20('east','/templates/basic/mapnav/east.gif');"  onmouseover="di20('east','/templates/basic/mapnav/east_F2.gif');" ><img id="east" alt="Pan East" src="//{$static_host}/templates/basic/mapnav/east.gif" width="30" height="29"/></a>{else}<img alt="East" title="East" id="east" src="//{$static_host}/templates/basic/mapnav/east_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" src="//{$static_host}/templates/basic/mapnav/shim.gif" width="1" height="29"/></td>
  </tr>

  <tr><!-- row 4 -->
   <td>{if $token_zoomout}<a accesskey="Q" title="Zoom out (Alt+Q)" href="/map2/{$token_zoomout}" onmouseout="di20('zoomout','/templates/basic/mapnav/zoomout.gif');"  onmouseover="di20('zoomout','/templates/basic/mapnav/zoomout_F2.gif');"><img id="zoomout" src="//{$static_host}/templates/basic/mapnav/zoomout.gif" width="30" height="29" alt="Zoom Out"/></a>{else}<img alt="Zoom Out" title="Can't zoom out any further" id="zoomout" src="//{$static_host}/templates/basic/mapnav/zoomout_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" id="fill5" src="//{$static_host}/templates/basic/mapnav/fill5.gif" width="30" height="29"/></td>
   <td>{if $token_zoomout}<a accesskey="X" title="Pan south (Alt+X)" href="/map2/{$token_south}" onmouseout="di20('south','/templates/basic/mapnav/south.gif');"  onmouseover="di20('south','/templates/basic/mapnav/south_F2.gif');"><img id="south" alt="Pan South" src="//{$static_host}/templates/basic/mapnav/south.gif" width="30" height="29"/></a>{else}<img alt="South" title="South" id="south" src="//{$static_host}/templates/basic/mapnav/south_F3.gif" width="30" height="29"/>{/if}</td>

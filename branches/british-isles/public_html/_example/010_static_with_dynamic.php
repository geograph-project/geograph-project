...
//setup the template
$template='_example_010_static_with_dynamic.tpl';	
$cacheid = '';

//this is used by variables in {dynamic} blocks
$smarty->assign("now",date('r'));

//do we need to do the heavy lifting, or is there a cached page available?
if (!$smarty->is_cached($template, $cacheid)) {
	//this is only saved when the page is generated
	$smarty->assign("static_now",date('r'));
} 

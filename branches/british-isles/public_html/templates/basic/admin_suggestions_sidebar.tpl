...
<td>{$ticket.submitter}{if $ticket.submitter_comment}<img src="{$static_host}/img/star-light.png" width="14" height="14" title="Comment: {$ticket.submitter_comment}"/>{/if}</td>
</tr>
<tr bgcolor="{$bgcolor}">

...
<span class="nowrap"><img src="{$static_host}/img/geotag_16.png" width="16" height="16" align="absmiddle" alt="geotagged!"/> <a href="/gridref/{$gridrefraw}/links"><b>More links for this square</b></a></span>
...
<p>{$groups} clusters shown. NB. Currently this map only counts images with both locations specified to 6 figures, similarly locations are only marked at 6 figure resolution.</p>

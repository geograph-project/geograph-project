...
{section loop=100 name=x start=0}
{assign var="x" value=$smarty.section.x.index}
{if $x%10 == 0} {/if}{if $grid.$x.$y}{assign var="mapcell" value=$grid.$x.$y}{if $mapcell.max_ftf > 9}+{elseif $mapcell.max_ftf}{$mapcell.max_ftf}{elseif $mapcell.imagecount}s{else}-{/if}{else} {/if}
{/section}

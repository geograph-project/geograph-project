...
<div style="background-color:pink; color:black; border:2px solid red; padding:10px;"><b>First time here?</b> - please checkout the following resources: <a href="/faq.php">FAQ</a>, <a href="/article/Geograph-Introductory-letter">Introduction</a> and <a href="/article/Geograph-Quickstart-Guide">Quickstart Guide</a>.</div>
 ...
 <h3>{external href="http://www.nearby.org.uk/geograph/upload/" text="Multi-Upload"}</h3>

...
{if $engine->resultCount}
  ...
  <tr>
	  ...
	  {/if}
		...
		{if $image->comment}
		<div class="caption" title="{$image->comment|escape:'html'}" style="font-size:0.7em;margin-top:2px">{$image->comment|escape:'html'|truncate:180:"... (<u>more</u>)"|geographlinks}</div>
		{/if}
      </td>
  </tr>

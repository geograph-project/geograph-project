...
<p>If you change the subject grid square of the photo, a "change suggestion" is raised
and a moderator will be notified.
When the moderator closes the suggestion, you will receive an email.</p>

<p>Similarly if you leave a message to the moderators <i>without making any changes</i>, a suggestion is raised
...
<p>If a change suggestion has been raised on one of your images, you may wish to comment
...
<h3>Notification emails about suggestions on your images</h3>
<p>By default you get a notification message when a suggestion is created, when a moderator
leaves a comment, and when the suggestion is closed. Recently we have added the option of 
the suggestor to flag a suggestion as minor, which is suggested for use on typo corrections
for example.</p>

<p>You can in your profile, choose to opt out of receiving notifications of new suggestions, 
...
<h3>Viewing current and closed change suggestions</h3> 
<p>The change request page also allows you to view details of current and closed
change suggestions. If the picture is yours, you can see full details and are
able to leave comments. For someone else's picture, all you see is the basic 
change request.</p>

<p>You can also find a list of <a href="/suggestions.php">recent suggestions</a> on your own 

...
class RebuildUserQuadSquares extends EventHandler
{
	function processEvent(&$event)
	{
		...
		$db->Execute("DROP TABLE IF EXISTS user_quadsquare_tmp");
		
		$db->Execute("CREATE TABLE user_quadsquare_tmp
		...
		$db->Execute("DROP TABLE IF EXISTS user_quadsquare");
		$db->Execute("RENAME TABLE user_quadsquare_tmp TO user_quadsquare");

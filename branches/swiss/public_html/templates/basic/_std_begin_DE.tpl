...
title="Geograph-CH" href="/stuff/osd.xml" />
<script type="text/javascript" src="{"/geograph.js"|revision}"></script>
</head>
<body>
<div id="header_block">
  <div id="header">
    <h1 onclick="document.location='/';"><a title="Geograph-CH Startseite" href="/">Geograph - fotografiere jeden Quadratkilometer</a></h1>
  </div>
</div>
{if $right_block}

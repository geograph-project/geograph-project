...
<head>
{if $page_title}<title>{$page_title|escape:'html'} :: Geograph Switzerland - photograph every grid square!</title>
{else}<title>Geograph Switzerland - photograph every grid square!</title>{/if}
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
{if $meta_description}<meta name="description" content="{$meta_description|escape:'html'|truncate:240:"... more"}" />
{else}<meta name="description" content="Geograph Switzerlandis a web based project to collect and reference geographically representative images of every square kilometre of Switzerland."/>{/if}

		...
		function loadmapO() {
			...
			for (var i in ris) {
				...
				var tilelayer = new OpenLayers.Layer.Geograph(
					...
					OpenLayers.Util.Geograph.MISSING_TILE_URL_BLUE200,
					{
...
Nach Anklicken des <img alt="+" src="/ol/img/layer-switcher-maximize.png" />-Symbols kann die UTM-Zone ausgewählt werden.</p>

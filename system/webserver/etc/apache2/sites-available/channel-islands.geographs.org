<VirtualHost *>
    ...
    RewriteCond %{HTTP_HOST}   !^kml\.channel\.geographs\.org [NC]
    RewriteCond %{HTTP_HOST}   !^t0\.channel\.geographs\.org [NC]
    RewriteCond %{HTTP_HOST}   !^s0\.channel\.geographs\.org [NC]
    RewriteCond %{HTTP_HOST}   !^$
    RewriteRule ^/(.*)         http://www.channel.virtual/$1 [L,R=permanent]

...
class UpdateContentWithUpdateStaticPage extends EventHandler
{
	...
	function processEvent(&$event)
	{
		...
		$lines = file_get_contents($url = "https://svn.geograph.org.uk/log.php?url=https://svn.geograph.org.uk/svn/branches/british-isles/public_html/templates/basic/".$filename);

...
function wgs84_to_osgb36($lat,$long) {
    ...
    $lat2  = XYZ_to_Lat ($x2,$y2,$z2,6377563.396,6356256.910);
    $long2 = XYZ_to_Long($x2,$y2); 
    
    $e = Lat_Long_to_East ($lat2,$long2,6377563.396,6356256.910,400000,0.999601272,49.00000,-2.00000);
    $n = Lat_Long_to_North($lat2,$long2,6377563.396,6356256.910,400000,-100000,0.999601272,49.00000,-2.00000);
...
function osgb36_to_wgs84($e,$n) {
    ...
    $lat1 = E_N_to_Lat ($e,$n,6377563.396,6356256.910,400000,-100000,0.999601272,49.00000,-2.00000);
    $lon1 = E_N_to_Long($e,$n,6377563.396,6356256.910,400000,-100000,0.999601272,49.00000,-2.00000);

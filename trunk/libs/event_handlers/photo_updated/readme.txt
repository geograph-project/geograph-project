photo_updated Event Handlers
------------------------

Insert class definitions in this directory to perform actions whenever a
photo has been updated. The parameter passed for this event is the
gridimage_id of the image and the field that has been updated

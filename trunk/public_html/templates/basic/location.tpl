...
<ul style="margin-top:0px; margin-bottom:0px">
	...
	{if $id}
		...
		<li>{external href="http://maps.live.com/default.aspx?v=2&amp;cp=`$lat`~`$long`&amp;style=h&amp;lvl=14&amp;tilt=-90&amp;dir=0&amp;alt=-1000&amp;mapurl=http://`$http_host`/photo/`$id`.kml&amp;encType=1" text="maps.live.com" title="detailed aerial photography from maps.live.com"} <small>(Redirects to <i>Multimap From Live Search</i>)</small></li>
	{else}
		...
		<li>{external href="http://maps.live.com/default.aspx?v=2&amp;cp=`$lat`~`$long`&amp;style=h&amp;lvl=14&amp;tilt=-90&amp;dir=0&amp;alt=-1000&amp;encType=1" text="maps.live.com" title="detailed aerial photography from maps.live.com"} <small>(Redirects to <i>Multimap From Live Search</i>)</small></li>
	{/if}
</ul>

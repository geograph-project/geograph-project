	...
	<dl>
		...
		<dd id="dd_self" style="border:1px solid gray; padding:5px">Use this option when you as the '<i>Geograph Account Holder</i>', also took the photo.</dd>
		...
		<dd id="dd_other" style="border:1px solid gray; padding:5px">By selecting the above option you certify that you as the '<i>Geograph Account Holder</i>',<br/> act as an authorised '<i>Licensor</i>' (<a href="/help/what_is_a_licensor" target="_blank">What does this mean</a>?) for the photographer named below:
		<br/><br/>

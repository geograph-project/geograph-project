...
<table class="navtable" border="0" cellpadding="0" cellspacing="0" width="143">
  ...
  <tr><!-- row 2 -->
   ...
   <td>{if $token_zoomout}<a accesskey="W" title="Pan north (Alt+W)" href="/mapbrowse.php?t={$token_north}" onmouseout="di20('north','/templates/basic/mapnav/north.gif');"  onmouseover="di20('north','/templates/basic/mapnav/north_F2.gif');" ><img id="north" alt="Pan North" src="/templates/basic/mapnav/north.gif" width="30" height="29"/></a>{else}<img alt="North" title="North" id="north" src="/templates/basic/mapnav/north_F3.gif" width="30" height="29"/>{/if}</td>
  ...
  <tr><!-- row 3 -->
   ...
   <td>{if $token_zoomout}<a accesskey="A" title="Pan west (Alt+A)" href="/mapbrowse.php?t={$token_west}" onmouseout="di20('west','/templates/basic/mapnav/west.gif');"  onmouseover="di20('west','/templates/basic/mapnav/west_F2.gif');"><img id="west" alt="Pan West" src="/templates/basic/mapnav/west.gif" width="30" height="29"/></a>{else}<img alt="West" title="West" id="west" src="/templates/basic/mapnav/west_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" id="fill4" src="/templates/basic/mapnav/fill4.gif" width="30" height="29"/></td>
   <td>{if $token_zoomout}<a accesskey="D" title="Pan east (Alt+D)" href="/mapbrowse.php?t={$token_east}" onmouseout="di20('east','/templates/basic/mapnav/east.gif');"  onmouseover="di20('east','/templates/basic/mapnav/east_F2.gif');" ><img id="east" alt="Pan East" src="/templates/basic/mapnav/east.gif" width="30" height="29"/></a>{else}<img alt="East" title="East" id="east" src="/templates/basic/mapnav/east_F3.gif" width="30" height="29"/>{/if}</td>
   <td><img alt="" src="/templates/basic/mapnav/shim.gif" width="1" height="29"/></td>
  </tr>
...
<div style="position:relative;">
	...
	<b><a title="right click and select&#13;&#10; [Copy Shortcut] or [Copy Link Location]" href="{if $token_zoomout}/map/{$mosaic_token}{else}{if $profile->nickname}/user/{$nickname|escape:'url'}/map/{else}/map/?u={$user_id}{/if}{/if}">Link to this Map</a></b>
	</div>
</div>
{/if}
<br/>

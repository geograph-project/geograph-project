...
<p>We currently have <b class="nowrap">{$stats.images|thousends} images</b> playable in the pool, a total of <b class="nowrap">{$stats.rates|thousends} ratings</b> have been recorded by <b class="nowrap">{$stats.raters|thousends} volenteers</b>, with more being added all the time. A further <b class="nowrap">{$stats.gone|thousends} images</b> have been classified as not suitable for game play.</p>

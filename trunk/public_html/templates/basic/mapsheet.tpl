...
<div class="{if $mapcell.has_geographs}g2{else}g1{/if}" style="left:{$x+0.2}em;top:{$y+1.6}em;"><div class="t">{if $mapcell.has_geographs}x{else}&nbsp;{/if}</div><div class="r">{$mapcell.grid_reference}</div></div>
{/foreach}
{/foreach}

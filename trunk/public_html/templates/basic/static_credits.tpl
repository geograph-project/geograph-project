{include file="_std_begin.tpl"}
    ...
    <h3>Original Idea</h3>
    <ul>
    <li>{mailto address="editor@geocachingtoday.com" text="Gary Rogers" encode="javascript"} - came up with original concept for his <a href="http://www.geocachingtoday.com/" title="Geocaching Today">Geocaching Today</a> online magazine</li>
    </ul>

	<h3>Photographs</h3>
    <ul>
    <li>Copyright on all photographs is retained by the original submitters, but all are 
    published under a <a title="Creative Commons website" href="http://creativecommons.org">Creative Commons</a> licence -

...
{dynamic}
 ...
 {/if}
		...
		{foreach from=$images item=image}
		  ...
		  <div style="float:left;width:150px;height:180px" class="photo33"><a title="{$image->title|escape:'html'} by {$image->realname} - click to view full size image" href="/photo/{$image->gridimage_id}">{$image->getThumbnail(120,120,false,true)}</a>

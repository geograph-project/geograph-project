{include file="_std_begin.tpl"}
 ...
 <li><a href="/help/style">Submission Style Guide</a></li>
 <li><a href="/help/changes">Change Request System</a></li>
 <li><a href="/help/stats_faq">Statistics FAQ</a></li>
 <li><a href="/help/bbcodes">Forum BBcodes</a></li>
...
<h3>Contributers...</h3>
<ul>
	<li><a href="/moversboard.php">Weekly Leaderboard</a></li>
	<li><a href="/leaderboard.php">All Time Leaderboard</a></li>
	<li><a href="/monthlyleader.php">By Month Leaderboard</a></li>
...
<ul>
   ...
   <li>Mostly Geographed: <ul>
	   ...
	   <li><a href="/statistics/most_geographed.php">10<small>km</small> x 10<small>km</small></a> Squares</li>
	   <li><a href="/statistics/most_geographed_myriad.php">100km x 100km</a> Squares</li>
	</ul>
	</li>
   <li>Fully Geographed: <ul>
	...
	<li>Breakdown by: <ul>
	   <li><a href="/statistics/breakdown.php?by=category">Category</a></li>
	   <li><a href="/statistics/breakdown.php?by=status">Status</a></li>
	   <li><a href="/statistics/breakdown.php?by=takenyear">Date Taken</a></li>
	   <li><a href="/statistics/breakdown.php?by=gridsq">100km x 100km Square</a></li>
	   <li><a href="/statistics/breakdown.php?by=user">Contributer</a></li>
	</ul>
	</li>
...
<li><a href="/conversion.php">Coordinate Conversion Demo</a></li>
</ul>

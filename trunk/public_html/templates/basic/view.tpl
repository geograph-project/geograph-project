...
{if $image->grid_square->reference_index eq 1}OSGB36{else}Irish{/if}: {getamap gridref=$image->subject_gridref text=$image->subject_gridref} [{$image->subject_gridref_accuracy}m precision]<br/>
WGS84: {$latdm} {$longdm}

...
function user_logged_in() 
{
	...
	elseif ($userpassword!='' and 
		$row=db_simpleSelect(0,$GLOBALS['Tu'],$GLOBALS['dbUserId'].','. $GLOBALS['dbUserSheme']['user_sorttopics'][1].','. $GLOBALS['dbUserSheme']['language'][1].','. $GLOBALS['dbUserAct'],$GLOBALS['dbUserSheme']['username'][1],'=',$username,'',1, $GLOBALS['dbUserSheme']['user_password'][1],'=',$userpassword))
	{
		$returned=TRUE;
